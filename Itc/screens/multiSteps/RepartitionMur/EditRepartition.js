 ...
 const EditRepartition: () => Node = ({ setEdit, setMur,mur,index,murs }) => {
    ...
    //  const [date, setDate] = useState(new Date());
     ...
     useEffect(() => {
        ...
        setNomDeMur(nomDeMur)
       setComposition(composition)
       setPosition(position)
       setEpaisseur(epaisseur)
       setIsolation(isolation)
       setTypeIsolation(typeIsolation)
       setEpaisseurIsolation(epaisseurIsolation)
       setResistanceIsolation(resistanceIsolation)
       setLongeur(longeur)
       setHauteur(hauteur)
       setOrienatation(orienation)
