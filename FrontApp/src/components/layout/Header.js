                ...
                <nav
                  ...
                  <div className="header-nav-inner">
                     ...
                     <ul className={
                      ...
                      <li>
                        <Link to="#" onClick={this.closeMenu}>Présentation</Link>
                      </li>
                    </ul>
                    <ul className={
                      classNames(
                      ...
                      <li>
                        <Link to="/secondary/" onClick={this.closeMenu}>Comment ça marche</Link>
                      </li>
                    </ul>
                    <ul className={
                      classNames(
                      ...
                      <li>
                        <Link to="#" onClick={this.closeMenu}>Nous contacter</Link>
                      </li>
                    </ul>
                    {!hideSignin &&
                      <ul
                      ...
                      >
                        <li>
                          <Link to="/login/" className="button button-primary button-wide-mobile button-sm" onClick={this.closeMenu}>Se connecter</Link>
                        </li>
                      </ul>}
                  </div>
                </nav>
