      ...
      <React.Fragment>
        ...
        <GenericSection topDivider className="center-content">
          <div className="container-xs">
            ...
            <ButtonGroup>
              <Button color="primary" wideMobile>Commencer</Button>
              <Button color="secondary" wideMobile>Commencer</Button>
              <Button color="dark" wideMobile>Commencer</Button>
            </ButtonGroup>
          </div>
        </GenericSection>
        ...
        <Testimonial className="illustration-section-03" />
